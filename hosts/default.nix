{
  ...
  flake = {
    ...
    microvm = inputs.microvm.nixosModules.host; # Include the microvm host module

    extra = inputs.nixos-extra-modules.nixosModules.default;
    extra_overlays = inputs.nixos-extra-modules.overlays.default;
